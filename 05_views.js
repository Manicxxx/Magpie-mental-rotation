...
const instructions_practice = magpieViews.view_generator("instructions", {
    ...
    text:  `In the following tasks you will see a pair of geometrical figures in
           ...
           shown figures are the same or different. You will indicate that with
           different letters on your keyboard. With the letter 'q' you will judge
           the figures as the same and with the letter 'p' you will judge them as
           being different.
              <br />
              <br />
